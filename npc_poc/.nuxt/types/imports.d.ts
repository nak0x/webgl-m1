...
export {}
declare global {
  const CarVehicle: typeof import('../../app/utils/three/npc/CarVehicle').default
  const HumanNPC: typeof import('../../app/utils/three/npc/HumanNPC').default
  const NPC: typeof import('../../app/utils/three/npc/NPC').default
  const NPCController: typeof import('../../app/utils/three/npc/NPCController').default
  const NPCFactory: typeof import('../../app/utils/three/npc/NPCFactory').default
  const NPCSettings: typeof import('../../app/utils/three/npc/NPCSettings').default
  const TrafficNetwork: typeof import('../../app/utils/three/npc/TrafficNetwork').default
  const TrafficNode: typeof import('../../app/utils/three/npc/TrafficNode').default
  const Vehicle: typeof import('../../app/utils/three/npc/Vehicle').default
  const VehicleNPC: typeof import('../../app/utils/three/npc/VehicleNPC').default
  ...
  const createBois: typeof import('../../app/utils/three/materials/createBois').createBois
  const createEau: typeof import('../../app/utils/three/materials/createEau').createEau
  const createError: typeof import('../../node_modules/nuxt/dist/app/composables/error').createError
  const createPlexiglass: typeof import('../../app/utils/three/materials/createPlexiglass').createPlexiglass
  ...
  const createVerre: typeof import('../../app/utils/three/materials/createVerre').createVerre
  ...
  const makePlexiTexture: typeof import('../../app/utils/three/textures/makePlexiTexture').makePlexiTexture
  const makeWoodTexture: typeof import('../../app/utils/three/textures/makeWoodTexture').makeWoodTexture
...
declare global {
  ...
  // @ts-ignore
  export type { CarVehicle } from '../../app/utils/three/npc/CarVehicle'
  import('../../app/utils/three/npc/CarVehicle')
  // @ts-ignore
  export type { HumanNPC } from '../../app/utils/three/npc/HumanNPC'
  import('../../app/utils/three/npc/HumanNPC')
  // @ts-ignore
  export type { NPC } from '../../app/utils/three/npc/NPC'
  import('../../app/utils/three/npc/NPC')
  // @ts-ignore
  export type { NPCController } from '../../app/utils/three/npc/NPCController'
  import('../../app/utils/three/npc/NPCController')
  // @ts-ignore
  export type { NPCFactory } from '../../app/utils/three/npc/NPCFactory'
  import('../../app/utils/three/npc/NPCFactory')
  // @ts-ignore
  export type { TrafficNetwork } from '../../app/utils/three/npc/TrafficNetwork'
  import('../../app/utils/three/npc/TrafficNetwork')
  // @ts-ignore
  export type { TrafficNode } from '../../app/utils/three/npc/TrafficNode'
  import('../../app/utils/three/npc/TrafficNode')
  // @ts-ignore
  export type { Vehicle } from '../../app/utils/three/npc/Vehicle'
  import('../../app/utils/three/npc/Vehicle')
  // @ts-ignore
  export type { VehicleNPC } from '../../app/utils/three/npc/VehicleNPC'
  import('../../app/utils/three/npc/VehicleNPC')
}
// for vue template auto import
import { UnwrapRef } from 'vue'
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly CarVehicle: UnwrapRef<typeof import('../../app/utils/three/npc/CarVehicle')['default']>
    readonly HumanNPC: UnwrapRef<typeof import('../../app/utils/three/npc/HumanNPC')['default']>
    readonly NPC: UnwrapRef<typeof import('../../app/utils/three/npc/NPC')['default']>
    readonly NPCController: UnwrapRef<typeof import('../../app/utils/three/npc/NPCController')['default']>
    readonly NPCFactory: UnwrapRef<typeof import('../../app/utils/three/npc/NPCFactory')['default']>
    readonly NPCSettings: UnwrapRef<typeof import('../../app/utils/three/npc/NPCSettings')['default']>
    readonly TrafficNetwork: UnwrapRef<typeof import('../../app/utils/three/npc/TrafficNetwork')['default']>
    readonly TrafficNode: UnwrapRef<typeof import('../../app/utils/three/npc/TrafficNode')['default']>
    readonly Vehicle: UnwrapRef<typeof import('../../app/utils/three/npc/Vehicle')['default']>
    readonly VehicleNPC: UnwrapRef<typeof import('../../app/utils/three/npc/VehicleNPC')['default']>
    ...
    readonly createBois: UnwrapRef<typeof import('../../app/utils/three/materials/createBois')['createBois']>
    readonly createEau: UnwrapRef<typeof import('../../app/utils/three/materials/createEau')['createEau']>
    readonly createError: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/error')['createError']>
    readonly createPlexiglass: UnwrapRef<typeof import('../../app/utils/three/materials/createPlexiglass')['createPlexiglass']>
    ...
    readonly createVerre: UnwrapRef<typeof import('../../app/utils/three/materials/createVerre')['createVerre']>
    ...
    readonly makePlexiTexture: UnwrapRef<typeof import('../../app/utils/three/textures/makePlexiTexture')['makePlexiTexture']>
    readonly makeWoodTexture: UnwrapRef<typeof import('../../app/utils/three/textures/makeWoodTexture')['makeWoodTexture']>
